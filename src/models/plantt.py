...
class PlanTT(Module):
    ...
    def forward(self,
        ...
        The sum of the element-wise differences between embeddings is considered as a prediction of expression difference.
        ...
        emb_a, emb_b = self.__tower(seq_a), self.__tower(seq_b)   # (BATCH SIZE, *) -> (BATCH SIZE, EMB_SIZE)
        
        # Return the sum of their element-wise differences
